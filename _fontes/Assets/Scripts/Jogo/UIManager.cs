...
public class UIManager : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        {
            VoiceName = Speaker.VoiceForCulture("pt-br").Name;
        } else
        {
            VoiceName = Speaker.Voices[0].Name;
        }
    }
    ...
    private void BuscarFurbot()
    {
        ...
        catch (System.NullReferenceException n) { furbot = GameObject.Find("Furbot_LAB").GetComponent<FurbotLAB>(); }
    }
    ...
    public IEnumerator Diga(Dialog_Char personagem, string texto)
    {
        ...
        Speaker.Speak(texto, null, Speaker.VoiceForName(PlayerPrefs.GetString("VoiceName")), true, PlayerPrefs.GetFloat("Rate"), PlayerPrefs.GetFloat("Pitch"));
    ...
    public void MostrarGameOver()
    {
        ...
        Speaker.Speak("Infelizmente você não completou a fase, tente novamente", null, Speaker.VoiceForName(PlayerPrefs.GetString("VoiceName")), true, PlayerPrefs.GetFloat("Rate"), PlayerPrefs.GetFloat("Pitch"));
    }
